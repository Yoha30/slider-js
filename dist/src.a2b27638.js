...
function Slider(slide) {
  ...
  var prev;
  var next;
  var slides = slide.querySelector('.slides');
  ...
  function move(direction) {
    ...
    var removeClasses = ['prev', 'current', 'next'];

    (_prev$classList = prev.classList).remove.apply(_prev$classList, removeClasses);

    (_current$classList = current.classList).remove.apply(_current$classList, removeClasses);

    (_next$classList = next.classList).remove.apply(_next$classList, removeClasses);
...
var slider = Slider(document.querySelector('.slider'));
